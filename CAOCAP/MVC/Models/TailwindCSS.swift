...
enum Tailwind: String {
    ...
    case topRightBottomLeft = "Top / Right / Bottom / Left"
    ...
    case gridColumnStartEnd = "Grid Column Start / End"
    case gridTemplateRows = "Grid Template Rows"
    case gridRowStartEnd = "Grid Row Start / End"
    ...
    case gradientColorStops = "Gradient Color Stops"
    ...
    case divideWidth = "Divide Width"
    case divideColor = "Divide Color"
    case divideStyle = "Divide Style"
    ...
    case ringColor = "Ring Color"
    case ringOffsetWidth = "Ring Offset Width"
    case ringOffsetColor = "Ring Offset Color"
    
    // Effects
    case boxShadow = "Box Shadow"
    case BoxShadowColor = "Box Shadow Color"
    ...
    case backdropBrightness = "Backdrop Brightness"
    case backdropContrast = "Backdrop Contrast"
    case backdropGrayscale = "Backdrop Grayscale"
    case backdropHueRotate = "Backdrop Hue Rotate"
    case backdropInvert = "Backdrop Invert"
    case backdropOpacity = "Backdrop Opacity"
    case backdropSaturate = "Backdrop Saturate"
    case backdropSepia = "Backdrop Sepia"
    ...
    // Accessibility
    case screenReaders = "Screen Readers"
}

typealias TailwindSet = (name: Tailwind, array: [String])

struct TailwindCSS {
    
    static let all: [TailwindSet] = [
        (name: .aspectRatio, array: aspectRatio),
        (name: .container, array: container),
        (name: .columns, array: columns),
        (name: .breakAfter, array: breakAfter),
        (name: .breakBefore, array: breakBefore),
        (name: .breakInside, array: breakInside),
        (name: .boxDecorationBreak, array: boxDecorationBreak),
        (name: .boxSizing, array: boxSizing),
        (name: .display, array: display),
        (name: .floats, array: floats),
        (name: .clear, array: clear),
        (name: .isolation, array: isolation),
        (name: .objectFit, array: objectFit),
        (name: .objectPosition, array: objectPosition),
        (name: .overflow, array: overflow),
        (name: .overscrollBehavior, array: overscrollBehavior),
        (name: .position, array: position),
        (name: .topRightBottomLeft, array: topRightBottomLeft),
        (name: .visibility, array: visibility),
        (name: .zIndex, array: zIndex),
        (name: .flexBasis, array: flexBasis),
        (name: .flexDirection, array: flexDirection),
        (name: .flexWrap, array: flexWrap),
        (name: .flex, array: flex),
        (name: .flexGrow, array: flexGrow),
        (name: .FlexShrink, array: FlexShrink),
        (name: .order, array: order),
        (name: .gridTemplateColumns, array: gridTemplateColumns),
        (name: .gridColumnStartEnd, array: gridColumnStartEnd),
        (name: .gridTemplateRows, array: gridTemplateRows),
        (name: .gridRowStartEnd, array: gridRowStartEnd),
        (name: .gridAutoFlow, array: gridAutoFlow),
        (name: .gridAutoColumns, array: gridAutoColumns),
        (name: .gridAutoRows, array: gridAutoRows),
        (name: .gap, array: gap),
        (name: .justifyContent, array: justifyContent),
        (name: .justifyItems, array: justifyItems),
        (name: .justifySelf, array: justifySelf),
        (name: .alignContent, array: alignContent),
        (name: .alignItems, array: alignItems),
        (name: .alignSelf, array: alignSelf),
        (name: .placeContent, array: placeContent),
        (name: .placeItems, array: placeItems),
        (name: .placeSelf, array: placeSelf),
        (name: .padding, array: padding),
        (name: .margin, array: margin),
        (name: .spaceBetween, array: spaceBetween),
        (name: .width, array: width),
        (name: .minWidth, array: minWidth),
        (name: .maxWidth, array: maxWidth),
        (name: .height, array: height),
        (name: .minHeight, array: minHeight),
        (name: .maxHeight, array: maxHeight),
        (name: .fontFamily, array: fontFamily),
        (name: .fontSize, array: fontSize),
        (name: .fontSmoothing, array: fontSmoothing),
        (name: .fontStyle, array: fontStyle),
        (name: .fontWeight, array: fontWeight),
        (name: .fontVariantNumeric, array: fontVariantNumeric),
        (name: .letterSpacing, array: letterSpacing),
        (name: .lineClamp, array: lineClamp),
        (name: .lineHeight, array: lineHeight),
        (name: .listStyleImage, array: listStyleImage),
        (name: .listStylePosition, array: listStylePosition),
        (name: .listStyleType, array: listStyleType),
        (name: .textAlign, array: textAlign),
        (name: .textColor, array: textColor),
        (name: .textDecoration, array: textDecoration),
        (name: .textDecorationColor, array: textDecorationColor),
        (name: .textDecorationStyle, array: textDecorationStyle),
        (name: .textDecorationThickness, array: textDecorationThickness),
        (name: .textUnderlineOffset, array: textUnderlineOffset),
        (name: .textTransform, array: textTransform),
        (name: .textOverflow, array: textOverflow),
        (name: .textIndent, array: textIndent),
        (name: .verticalAlign, array: verticalAlign),
        (name: .whitespace, array: whitespace),
        (name: .wordBreak, array: wordBreak),
        (name: .hyphens, array: hyphens),
        (name: .content, array: content),
        (name: .backgroundAttachment, array: backgroundAttachment),
        (name: .backgroundClip, array: backgroundClip),
        (name: .backgroundColor, array: backgroundColor),
        (name: .backgroundOrigin, array: backgroundOrigin),
        (name: .backgroundPosition, array: backgroundPosition),
        (name: .backgroundRepeat, array: backgroundRepeat),
        (name: .backgroundSize, array: backgroundSize),
        (name: .backgroundImage, array: backgroundImage),
        (name: .gradientColorStops, array: gradientColorStops),
        (name: .borderRadius, array: borderRadius),
        (name: .borderWidth, array: borderWidth),
        (name: .borderColor, array: borderColor),
        (name: .borderStyle, array: borderStyle),
        (name: .divideWidth, array: divideWidth),
        (name: .divideColor, array: divideColor),
        (name: .divideStyle, array: divideStyle),
        (name: .outlineWidth, array: outlineWidth),
        (name: .outlineColor, array: outlineColor),
        (name: .outlineStyle, array: outlineStyle),
        (name: .outlineOffset, array: outlineOffset),
        (name: .ringWidth, array: ringWidth),
        (name: .ringColor, array: ringColor),
        (name: .ringOffsetWidth, array: ringOffsetWidth),
        (name: .ringOffsetColor, array: ringOffsetColor),
        (name: .boxShadow, array: boxShadow),
        (name: .BoxShadowColor, array: BoxShadowColor),
        (name: .opacity, array: opacity),
        (name: .mixBlendMode, array: mixBlendMode),
        (name: .backgroundBlendMode, array: backgroundBlendMode),
        (name: .blur, array: blur),
        (name: .brightness, array: brightness),
        (name: .contrast, array: contrast),
        (name: .dropShadow, array: dropShadow),
        (name: .grayscale, array: grayscale),
        (name: .hueRotate, array: hueRotate),
        (name: .invert, array: invert),
        (name: .saturate, array: saturate),
        (name: .sepia, array: sepia),
        (name: .backdropBlur, array: backdropBlur),
        (name: .backdropBrightness, array: backdropBrightness),
        (name: .backdropContrast, array: backdropContrast),
        (name: .backdropGrayscale, array: backdropGrayscale),
        (name: .backdropHueRotate, array: backdropHueRotate),
        (name: .backdropInvert, array: backdropInvert),
        (name: .backdropOpacity, array: backdropOpacity),
        (name: .backdropSaturate, array: backdropSaturate),
        (name: .backdropSepia, array: backdropSepia),
        (name: .borderCollapse, array: borderCollapse),
        (name: .borderSpacing, array: borderSpacing),
        (name: .tableLayout, array: tableLayout),
        (name: .captionSide, array: captionSide),
        (name: .transitionProperty, array: transitionProperty),
        (name: .transitionDuration, array: transitionDuration),
        (name: .transitionTimingFunction, array: transitionTimingFunction),
        (name: .transitionDelay, array: transitionDelay),
        (name: .animation, array: animation),
        (name: .scale, array: scale),
        (name: .rotate, array: rotate),
        (name: .translate, array: translate),
        (name: .skew, array: skew),
        (name: .transformOrigin, array: transformOrigin),
        (name: .accentColor, array: accentColor),
        (name: .appearance, array: appearance),
        (name: .cursor, array: cursor),
        (name: .caretColor, array: caretColor),
        (name: .pointerEvents, array: pointerEvents),
        (name: .resize, array: resize),
        (name: .scrollBehavior, array: scrollBehavior),
        (name: .scrollMargin, array: scrollMargin),
        (name: .scrollPadding, array: scrollPadding),
        (name: .scrollSnapAlign, array: scrollSnapAlign),
        (name: .scrollSnapStop, array: scrollSnapStop),
        (name: .scrollSnapType, array: scrollSnapType),
        (name: .touchAction, array: touchAction),
        (name: .userSelect, array: userSelect),
        (name: .willChange, array: willChange),
        (name: .fill, array: fill),
        (name: .stroke, array: stroke),
        (name: .strokeWidth, array: strokeWidth),
        (name: .screenReaders, array: screenReaders),
    ...
    /* Object Fit */
    static let objectFit = [
        "object-contain","object-cover","object-fill","object-none","object-scale-down",
    ]
    
    /* Object Position */
    static let objectPosition = [
    ...
    static let gridTemplateColumns = [
    ...
    /* Align Items */
    static let alignItems = [
        "items-start","items-end","items-center","items-baseline","items-stretch",
    ]
    
    /* Align Self */
    static let alignSelf = [
        "self-auto","self-start","self-end","self-center","self-stretch","self-baseline",
    ]
    
    /* Place Content */
    static let placeContent = [
    ...
    /* Font Smoothing */
    static let fontSmoothing = [
        "antialiased","subpixel-antialiased",
    ]
    
    /* Font Style */
    static let fontStyle = [
        "italic","not-italic",
    ]
    ...
    /* List Style Image */
    static let listStyleImage = [
        "list-image-none",
    ]
    
    /* List Style Position */
    static let listStylePosition = [
        "list-inside","list-outside",
    ]
    
    /* List Style Type */
    static let listStyleType = [
        "list-none","list-disc","list-decimal",
    ]
    
    /* Text Align */
    static let textAlign = [
    ...
    /* Text Decoration */
    static let textDecoration = [
        "underline","overline","line-through","no-underline",
    ]
    
    /* Text Decoration Color */
    static let textDecorationColor = [
    ...
    static let backgroundAttachment = [
        "bg-fixed","bg-local","bg-scroll",
    ]
    
    /* Background Clip */
    static let backgroundClip = [
    ...
    /* Border Style */
    static let borderStyle = [
        "border-solid","border-dashed","border-dotted","border-double","border-hidden","border-none",
    ]
    
    /* Divide Width */
    static let divideWidth = [
    ...
    /* Box Shadow */
    static let boxShadow = [
        "shadow-sm","shadow","shadow-md","shadow-lg","shadow-xl","shadow-2xl","shadow-inner","shadow-none",
    ]
    
    /* Box Shadow Color */
    static let BoxShadowColor = [
    ...
    /* Backdrop Grayscale */
    static let backdropGrayscale = [
        "backdrop-grayscale-0","backdrop-grayscale",
    ]
    
    /* Backdrop Hue Rotate */
    static let backdropHueRotate = [
    ...
    /* Backdrop Invert */
    static let backdropInvert = [
        "backdrop-invert-0","backdrop-invert",
    ]
    
    /* Backdrop Opacity */
    static let backdropOpacity = [
    ...
    /* Border Collapse */
    static let borderCollapse = [
        "border-collapse","border-separate",
    ]
    
    /* Border Spacing */
    static let borderSpacing = [
    ...
    /* Table Layout */
    static let tableLayout = [
        "table-auto","table-fixed",
    ]
    
    /* Caption Side */
    static let captionSide = [
    ...
    static let transitionTimingFunction = [
        "ease-linear","ease-in","ease-out","ease-in-out",
    ]
    
    /* Transition Delay */
    static let transitionDelay = [
    ...
    /* Scroll Behavior */
    static let scrollBehavior = [
        "scroll-auto","scroll-smooth",
    ]
    
    /* Scroll Margin */
    static let scrollMargin = [
    ...
    /* User Select */
    static let userSelect = [
        "select-none","select-text","select-all","select-auto",
    ]
    
    /* Will Change */
    static let willChange = [
